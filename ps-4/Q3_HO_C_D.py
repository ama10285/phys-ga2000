...
error_gq = abs(sqrt(uc_gq) - 2.3)
print("Approximation Error using Gaussian Quadrature =", error_gq)
...
error_gh = abs(sqrt(uc_gh/(math.factorial(5)*sqrt(pi)*(2**5))) - 2.3)
print("Approximation Error using Gauss Hermite Quadrature =", error_gh)
